...
setup(
    ...
    description='percolation is a python package for harnessing open linked social data',
    ...
    install_requires=['rdflib', 'rfc3986', 'networkx', 'pygraphviz', 'numpy', 'nltk', 'matplotlib', 'SPARQLWrapper', 'powerlaw', 'scipy', 'setuptools', 'social', 'ipython', 'python-dateutil', 'scikit-learn'],
